...
stopifnot(isTRUE(all.equal(data$marker_size[[1L]], 0.62)))
stopifnot(identical(data$marker_size[[3L]], 0.1))
stopifnot(identical(calculate_marker_size(1000000), 2))
stopifnot(all(data$marker_size >= 0.1 & data$marker_size <= 2))
